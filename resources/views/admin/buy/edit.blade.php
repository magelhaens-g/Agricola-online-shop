            ...
            <div class="box-body">
                <form action="{{ route('admin.product.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group @error('title') has-error @enderror">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Enter product title" value="{{ $product->title ?? old('title') }}">
                        @error('title')
                    ...
                    <div class="form-group @error('desc') has-error @enderror">
                        ...
                        <textarea rows="3" name="desc" class="form-control" placeholder="Enter product description">{{ $product->desc ?? old('desc') }}</textarea>
                        @error('desc')
                        <span class="help-block">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group @error('price') has-error @enderror">
                        ...
                        <input type="number" name="price" class="form-control" placeholder="Enter price" value="{{ $product->price ?? old('price') }}">
                        @error('price')
                        <span class="help-block">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group @error('stock') has-error @enderror">
                        ...
                        <input type="number" name="stock" class="form-control" placeholder="Enter stock" value="{{ $product->stock ?? old('stock') }}">
                        @error('stock')
                        <span class="help-block">{{ $message }}</span>
                        @enderror
                    </div>
